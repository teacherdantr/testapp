...
import { PlusCircle, FileText, AlertTriangle, Search, AlertCircleIcon } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <h2 className="text-2xl font-semibold">Existing Tests</h2>
          ...
          <div className="text-center py-10 bg-card rounded-lg shadow">
            {searchTerm ? (
                <>
                    ...
                    <p className="text-muted-foreground text-lg">No tests match your search for "{searchTerm}".</p>
